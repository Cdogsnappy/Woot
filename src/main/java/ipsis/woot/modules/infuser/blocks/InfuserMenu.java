...
public class InfuserMenu extends WootContainer implements TankPacketHandler {
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(playerIn.level(),blockEntity.getBlockPos()), playerIn, InfuserSetup.INFUSER_BLOCK.get());
    }
